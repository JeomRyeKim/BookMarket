...
#mynavbar1{margin-right: 260px;}
#mynavbar2-1{margin-left: 260px;}
...
<nav class="navbar navbar-expand-sm bg-light">
      <ul class="navbar-nav">
         <li class="nav-item dropdown" id="mynavbar2-1">
		    <a class="nav-link active dropdown-toggle text-dark" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
