...
<div class="container">
  <form name="newUpdate" 
  		action="BoardUpdateAction.do?num=${bbs.num}&pageNum=${page}&items=${items}&text=${text}"
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input name="name" class="form-control" value="${bbs.name}">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8" style="word-break:break-all;"> <%-- break-all : 문자를 강제로 줄바꿈 가능 --%>
  ...
  <!-- 이미지 -->
   <div class="form-group row">
      <label class="col-sm-2">이미지</label>
       <div class="col-sm-5">
         <img style="width: 500px;" id="preview-image" src="/resources/board/images/${bbs.attachFile}" >
