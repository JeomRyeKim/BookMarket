...
<%@page import="dto_old.RecentProduct"%><%@page import="dao_old.ProductRepository"%><%@page import="dto_old.Product"%><%@page import="java.util.ArrayList"%>
   ...
   <div class="row" align="center">
    <%@ include file="dbconn.jsp" %>
     <%  /* DB로 부터 상품 정보 리스트 얻기 */
      ...
      %>
      <div class="col-md-4">
        <img src="/resourses/images/<%=rs.getString("p_fileName")%>"  style="width:100%">
